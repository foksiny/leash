...
export const KEYWORD_DOCS: Record<string, string> = {
    ...
    'use': 'Imports an item from another module: `use module::Item;`. Use `alias` to create a local name: `use mymod alias mm;` or `use mod::Item alias Short;`.',
    'alias': 'Creates a local alias for an import: `use mymod alias mm;` then `mm.item`, or `use mod::LongName alias Short;`.',
