...
(defconst leash-font-lock-keywords
    (list
     '("\\b\\(fnc\\|def\\|struct\\|union\\|enum\\|class\\|type\\|template\\|macro\\|return\\|if\\|also\\|else\\|unless\\|while\\|for\\|do\\|foreach\\|loop\\|in\\|imut\\|vec\\|vector\\|this\\|pub\\|priv\\|static\\|stop\\|continue\\|empty\\|ignore\\|use\\|works\\|otherwise\\|switch\\|case\\|default\\|unsafe\\|as\\|inline\\|defer\\|error\\|throw\\|self\\|alsou\\|create\\|del\\|is\\|isnt\\)\\b" . font-lock-keyword-face)
