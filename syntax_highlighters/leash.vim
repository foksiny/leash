...
syn keyword leashBuiltin show showb get keyget set toint tofloat tostring cstr lstr normescape size cur name pushb popb pushf popf insert clear remove extend extendv isin rand randf seed choose wait timepass exit exec inttobytes bytestoint floattobytes bytestofloat getKey keys values delete push
